...
image: https://raw.githubusercontent.com/JCDMeira/pjs_proRpg/master/src/assets/images/arvak.jpeg
category: Arvak
tags:
  - personagens
---
...
Talento de nível 0 mente sobre o corpo.

## mago Level 1: (prevalece HP o maior entre nível 0 e nível 1)

HP além do nível 1 = d6 + mod int
6 (d6) +3 (mod-int) = 9
...
2 (d6) +3 = 4 (como o dano deu menos que metade + 1 do valor máximo do dado)
4 + 3 = 7 [23]

## mago Level 4:

1 (d6) +3 = 4 (como o dano deu menos que metade + 1 do valor máximo do dado)
4 + 3 = 7 [30]

- aumento de atributos: +2 de int
- magias aprendidas
  - Passo Nebuloso
  - cegueira/surdez
- truque aprendido
...
que sejam desconhecidos ou terrenos inóspitos. Ele recebe +2 em testes de Destreza e +2 contra testes de medo por circunstância, mas não por Criatura.

Altruísta: 3 pts – Ant. = PJ foi criado de uma maneira inversa ao egoísmo, sempre que realizar um teste para ajudar um amigo ou um indefeso desconhecido, ele poderá gastar 1 ponto de energia e repetir o teste caso ele tenha falhado, com um bônus de +1d6 por ponto de energia gasto.

Noção de perigo: 3 pt. = O mestre deverá retirar sem aviso prévio 1 ponto de energia do jogador e avisá-lo que o perigo está próximo. O jogador pode anunciar que quer gastar 1 ponto de energia para saber se corre riscos ou não.

# Progresso

| Data     | XP Ganha | Motivo                                     | XP total | Nível |
| -------- | -------- | ------------------------------------------ | -------- | ----- |
| 21-07-24 | 900      | Criação da fixa                            | 900      | 3     |
| 23-07-24 | 2100     | Mesa da Anna                               | 3000     | 4     |
| 15-08-24 | 1500     | Mestrar mesa nível 7                       | 4500     | 4     |
| 17-08-24 | 1300     | Mestrar mesa nível 6                       | 5800     | 4     |
| 18-08-24 | 1300     | Mestrar mesa nível 6                       | 6100     | 4     |
| 19-08-24 | 2100     | Mestrar mesa nível 10                      | 8200     | 5     |
| 25-08-24 | 2550     | Mesa As criptas de Zaldara mestre vínicius | 10750    | 5     |
| 29-08-24 | 2100     | Mestrar mesa nível 10                      | 12850    | 5     |
| 31-08-24 | 1300     | Mestrar mesa nível 6                       | 14150    | 6     |
